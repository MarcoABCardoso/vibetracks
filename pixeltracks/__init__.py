...
``compositor`` (≈ sequencer), ``spec`` (model + validator), ``pngio`` (≈ wavio).
Coherence comes from a shared art bible: one palette, reusable shape motifs, and
the leitmotif move of a **palette swap**.
"""
